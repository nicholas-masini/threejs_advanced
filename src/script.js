...
// material.color = new THREE.Color(0x000050)
...
const pointLight2 = new THREE.PointLight(0xf21212, 5);
...
const pointLight3 = new THREE.PointLight(0x1515e8, 5);
pointLight3.position.set(1, -1.19, -1.6);
